...
/**
 * React node view for the VideoNode extension.
 * Renders a <video> with:
 *   - floating alignment toolbar (left / center / right) when selected
 *   - right-edge drag-resize handle (identical UX to ResizableImageView)
 */
